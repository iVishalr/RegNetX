    ...
    def train(self):
        ...
        def run_epoch(split):
            ...
            if is_train:
                ...
                model.eval() # important for batchnorm during testing

            data = self.train_dataset if is_train else self.test_dataset
            loader = DataLoader(data, batch_size=config.batch_size, num_workers=config.num_workers, pin_memory=config.pin_memory, shuffle=config.shuffle)
